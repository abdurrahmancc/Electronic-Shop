          ...
          <div className="grid lg:grid-cols-5 grid-cols-1">
            <div className="col-span-2 w-full">
              <div class="avatar justify-center w-full">
                <div class="w-44 h-44 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2">
              ...
              <div className="text-center mt-2">
                <label htmlFor="updatePhotoModal">
                  <label htmlFor="updatePhoto">
                    ...
                    <h5 className=" px-5 py-2 max-w-[128px] text-center mx-auto bg-primary rounded-full text-neutral capitalize font-normal">
                      Upload Photo
                    </h5>
                  </label>
                </label>
